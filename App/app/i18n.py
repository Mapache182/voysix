TRANSLATIONS = {
    "en": {
        ...
        "restore_hotkey": "Restore Last Text Hotkey:",
    ...
    "ru": {
        ...
        "restore_hotkey": "Клавиша восстановления:",
    ...
    "es": {
        ...
        "restore_hotkey": "Tecla de restauración:",
...
HELP_TEXT = {
    "en": {
        ...
        "restore_hotkey_help": "<b>Restore Hotkey:</b><br>Hotkey to restore the last transcribed text back to the clipboard and paste it if accidentally overwritten. Double-clicking the floating window or double-clicking the main hotkey (if middle click) also works.",
    ...
    "ru": {
        ...
        "restore_hotkey_help": "<b>Клавиша восстановления:</b><br>Клавиша для возврата последнего распознанного текста в буфер обмена и его вставки, если вы случайно перезаписали буфер. Также работает двойной клик по плавающему окну или двойное нажатие основной клавиши записи (если это средняя кнопка мыши).",
    ...
    "es": {
        ...
        "restore_hotkey_help": "<b>Tecla de restauración:</b><br>Tecla para restaurar el último texto transcrito al portapapeles y pegarlo si se sobrescribió accidentalmente. También funciona hacer doble clic en la ventana flotante o doble clic en la tecla de activación (si es clic central).",
